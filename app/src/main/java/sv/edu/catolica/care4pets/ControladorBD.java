...
public class ControladorBD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Medicamentos(ID_Medicamento integer primary key,Nombre text,dosis integer,hora_ini datetime,notas text, Presentacion text,Cantidad text,Unidad text,FechaVencimiento date,Laboratorio text)");
