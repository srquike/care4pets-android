...
public class ControladorBD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Evento(ID_Evento integer primary key autoincrement,Nombre text, Fecha date,Hora datetime,Mascota text,TipoEvento text,Descripcion text)");
